                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            @if (!empty($permissions))
                                ...
                                <table class="table mb-0 table-striped" id="">
                                    <thead>
                                        <tr>
                                            <th>
                                                <input type="checkbox"
                                                    class="align-middle form-check-input custom_align_middle"
                                        ...
                                        @foreach ($modules as $module)
                                            <tr>
                                                <td><input type="checkbox"
                                                        class="align-middle form-check-input ischeck staff_checkall"
                                ...
                                <table class="table mb-0 table-striped" id="">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($modules as $module)
                                            <tr>
                                                <td><input type="checkbox"
                                                        class="align-middle form-check-input ischeck crm_checkall"
                                ...
                                <table class="table mb-0 table-striped" id="">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($modules as $module)
                                            <tr>
                                                <td><input type="checkbox"
                                                        class="align-middle form-check-input ischeck project_checkall"
                                                        data-id="{{ str_replace(' ', '', $module) }}"></td>
                                ...
                                <table class="table mb-0 table-striped" id="">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($modules as $module)
                                            <tr>
                                                <td><input type="checkbox"
                                                        class="align-middle form-check-input ischeck hrm_checkall"
                                                        data-id="{{ str_replace(' ', '', $module) }}"></td>
                                ...
                                <table class="table mb-0 table-striped" id="">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($modules as $module)
                                            <tr>
                                                <td><input type="checkbox"
                                                        class="align-middle form-check-input ischeck account_checkall"
                                                        data-id="{{ str_replace(' ', '', $module) }}"></td>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($modules as $module)
                                            <tr>
                                                ...
                                                <td><input type="checkbox"
                                                        class="align-middle form-check-input ischeck pos_checkall"
                                                        data-id="{{ str_replace(' ', '', $module) }}"></td>
