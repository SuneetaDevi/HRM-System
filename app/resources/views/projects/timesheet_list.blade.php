...
@section('content')
    <div class="mt-4 row">
        <div class="col-12">
            <div class="card ">
                <div class="overflow-auto card-wrapper project-timesheet"></div>
    ...
    <script>
        ...
        $(document).on('click', '[data-ajax-timesheet-popup="true"]', function(e) {
            ...
            $("#commonModal .modal-title").html(title + ` <small>(` + moment(date).format("ddd, Do MMM YYYY") +
                `)</small>`);
                console.log('Image clicked! before ajax in orther file');
        ...
        function showDayType(type) {
            if (type === 'full_day') {
                $('#commonModal').find('.display-total-time span').text(
