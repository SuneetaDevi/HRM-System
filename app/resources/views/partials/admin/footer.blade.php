...
<footer class="dash-footer">
    <div class="footer-wrapper">
        <div class="py-1">
            ...
            Copyright &copy; THE FAS SOLUTIONS LTD 2010 - {{ date('Y') }} All Rights Reserved. <!-- {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', ' FAS ERP') }} -->
            </p>
        </div>
    </div>
</footer>
