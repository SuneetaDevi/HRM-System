        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-5">
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    ...
                    >
                    <a href="https://faserp.com/" class="btn btn-outline-light" target="_blank"
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 text-end">
                ...
                <p class="text-body">Copyright © 2010 - 2023 | Powered by <a href="https://www.thefas-solutions.com" target="_blank">THE FAS SOLUTIONS Ltd</a></p>
            </div>
        </div>
    </div>
</section>
