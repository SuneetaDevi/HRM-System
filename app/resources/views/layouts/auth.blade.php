...
<head>
    <title>{{(Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'FAS ERP')}} - @yield('page-title')</title>
...
{{--                    <img src="{{ asset('assets/images/logo-dark.png') }}" alt="logo"/>--}}
                    @if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on' )
                        <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') }}"
                             alt="{{ config('app.name', 'FAS ERP') }}" class="logo">
                    @else
            ...
            <div class="row align-items-center text-start">
                ...
                <div class="col-xl-6 img-card-side">
                    <div class="auth-img-content">
                        ...
                        <p class="text-white">
                            Streamlining Operations, Boosting Productivity
                            & Empowering Business Operations with Real-time Insights.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="auth-footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6">
                        <p class="mb-0">
                        Copyright &copy; THE FAS SOLUTIONS LTD 2010 - {{ date('Y') }} All Rights Reserved. <!-- {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', ' All Rights Reserved.') }} -->
                        </p>
                    </div>
