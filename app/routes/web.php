...
//    Route::get('timesheet-table-view', [TimesheetController::class, 'filterTimesheetTableView'])->name('filter.timesheet.table.view')->middleware(['auth', 'XSS']);
    ...
    Route::get('timesheet/export/{id}', [TimesheetController::class, 'timesheetExport'])->name('timesheet.export')->middleware(['auth', 'XSS']);
Route::post('timesheet/export/store/{id}', [TimesheetController::class, 'timesheetExportStore'])->name('timesheet.export.store')->middleware(['auth', 'XSS']);
